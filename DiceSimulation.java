...
/**
 ...
 pair of doubles.
 This is Lab2 from CS110 Spring 2022 Jackie Horton
 */

public class DiceSimulation {
    public static void main(String[] args) {
        //the number of times to roll the dice
        //a random number generator used in simulating rolling dice
        ...
        for(count = 0; count < NUMBER; count++){
            die1Value = generator.nextInt((6-1)+1) + 1;
            die2Value = generator.nextInt((6-1)+1) + 1;
